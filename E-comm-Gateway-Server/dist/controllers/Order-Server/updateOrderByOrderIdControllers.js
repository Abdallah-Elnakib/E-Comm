...
const updateStatusOrderByOrderId = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const response = yield (0, FetchAnotherServer_1.fetchAnotherServer)(`${process.env.ORDERSERVER}/api/orders/update-status-order/${req.params.OrderId}`, 'POST', req.body);
